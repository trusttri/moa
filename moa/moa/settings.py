...
SECRET_KEY = 'django-insecure-sl$ihqib=w%5j)u5r2db5ml2n@g-9k5+6r0bm)a_9ek7d*5qbz'
...
ASGI_APPLICATION = 'moa.asgi.application'
...
EMAIL_HOST_PASSWORD = SENDGRID['API_KEY']
EMAIL_PORT = 587
EMAIL_USE_TLS = True
